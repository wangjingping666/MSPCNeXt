...
class Block_3(nn.Module):
    def __init__(self, dim,drop_path=0.6, layer_scale_init_value=1e-6):
        ...
        self.dwconv1_1_3 = nn.Conv2d(dim, 96, kernel_size=1)
        # self.dwconv = nn.Conv2d(96, 96, kernel_size=3, padding=1, groups=96)  # depthwise conv
        self.dwconv3_3_a1 = nn.Conv2d(96, 96, kernel_size=(3,1), padding=(1,0), groups=96)  # depthwise conv
        self.dwconv3_3_a2 = nn.Conv2d(96, 96, kernel_size=(1,3), padding=(0,1), groups=96)  # depthwise conv
...
class Block_7(nn.Module):
    def __init__(self, dim,drop_path=0.6, layer_scale_init_value=1e-6):
        ...
        self.dwconv7_7_a1 = nn.Conv2d(96, 96, kernel_size=(7, 1), padding=1, groups=96)
...
class BNConvBlock_d_1(nn.Module):
    def __init__(self, dim, drop_path=0.6, layer_scale_init_value=1e-6):
        ...
        self.dwconv5_5_a1 = nn.Conv2d(dim_d, dim_d, kernel_size=(5, 1), padding=1, groups=dim_d)
        ...
        # self.dwconv7_7_a = nn.Conv2d(dim_d, dim_d, kernel_size=7, padding=3, groups=dim_d)
        # self.bn1 = BN(dim_d, eps=0.001)
        self.dwconv9_9_a1 = nn.Conv2d(dim_d, dim_d, kernel_size=(9, 1), padding=2, groups=dim_d)
        ...
        self.dwconv11_11_b1 = nn.Conv2d(dim_d, dim_d, kernel_size=(11, 1), padding=2, groups=dim_d)
    ...
    def forward(self, x):
        ...
        dwconv5_5_a1 = self.dwconv5_5_a1(dwconv1_1_5)
